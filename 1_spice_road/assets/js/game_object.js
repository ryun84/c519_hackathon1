class Game {
    ...
    createMerchantCard() {
        ...
        if (rNG === 1) {
            ...
            this.availableMerchCardsArrayforPlayertoClickAndC.push(tradeCard);
        }
        this.displayMerchantCardInfo();
    }
    ...
    displayMerchantCardInfo() {
        for (var counter = 0; counter < 6; counter++) {
            var merchantInnerArray = this.availableMerchCardsArrayforPlayertoClickAndC[counter];
